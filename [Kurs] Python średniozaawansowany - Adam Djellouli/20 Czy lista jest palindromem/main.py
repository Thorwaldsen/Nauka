...
print(lista1.czy_palindrom_v1())
print(lista2.czy_palindrom_v1())
print(lista3.czy_palindrom_v1())

print(lista1.czy_palindrom_v2())
print(lista2.czy_palindrom_v2())
print(lista3.czy_palindrom_v2())