...
print("P obwod:", prostokat.obwod(), "P pole:", prostokat.pole_powierzchni())
print("K obwod:", kwadrat.obwod(), "K pole:", kwadrat.pole_powierzchni())
print("Sz pole:", szescian.pole_powierzchni(), "Sz objetosc", szescian.objetosc())
